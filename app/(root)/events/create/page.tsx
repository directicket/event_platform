  ...
  return (
    ...
    <section className="bg-black md:max-w-4xl bg-cover bg-center py-2 wrapper">
      <h2 className="p-regular-20 md:p-regular-20 text-wrap text-white">Create a Ticket</h2>
        <p className="text-neutral-600 text-left">If you haven't,{' '}<a href='/profile/bank-details' className='text-blue-700 underline'>click here to add your banking details.</a>{' '}Make sure your Ticket contains accurate details.</p>
    </section> 
