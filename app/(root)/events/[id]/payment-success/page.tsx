...
import { CircleCheck, TriangleAlert, Ticket } from 'lucide-react';
      ...
      <div className="mt-16 wrapper md:max-w-xl text-white grid grid-cols-1 gap-2 md:gap-4 justify-center items-center mb-8">
        ...
        <div>
          <p className='p-regular-14 text-white mt-2'>
            You can always find this ticket by going to Your Dashboard {">"} My Purchases. DO NOT share this ticket with anyone.
